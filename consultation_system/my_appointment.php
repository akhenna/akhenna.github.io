    ...
    <?php if($result && $result->num_rows > 0): ?>
        <?php while($row = $result->fetch_assoc()): ?>
            ...
            <div class="card">
                ...
                <div class="info">
                    <strong>Faculty:</strong> <?= htmlspecialchars($facultyName) ?>
                </div>

                <div class="info">
                    <strong>Schedule:</strong> <?= htmlspecialchars($row['schedule']) ?>
                </div>

                <div class="info">
                    <strong>Date:</strong> <?= date("F d, Y", strtotime($row['appointment_date'])) ?>
                </div>

                <div class="info">
                    <strong>Submitted:</strong> <?= date("F d, Y h:i A", strtotime($row['created_at'])) ?>
                </div>
